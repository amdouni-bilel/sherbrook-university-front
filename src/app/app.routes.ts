...
// 
                  ...
                  {path: 'list-students', loadChildren: () => import('app/modules/sherbrook/components/students/students.routes')},
                  {path: 'add-user', loadChildren: () => import('app/modules/sherbrook/components/users/add-user/add-user-components.routes')},
                  {path: 'add-student', loadChildren: () => import('app/modules/sherbrook/components/users/add-user/add-user-components.routes')},
                  ...
                  { path: 'update-student/:id', loadChildren: () => import('app/modules/sherbrook/components/users/update-user/update-user-components.routes') },
                  ...
                  { path: 'update-teacher/:id', loadChildren: () => import('app/modules/sherbrook/components/teachers/update-teacher/update-teacher-components.routes') },
